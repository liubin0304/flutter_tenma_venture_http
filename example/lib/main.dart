...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void getCode() async {
    // final randomStr = TMEncryptionTool.getRandomString(10);
    // print(randomStr);
    //
    // var params = {'round_verify': "Dx5WjMTFrc"};
    // DioManager().get(
    //     url: "/Login/getCode",
    //     params: params,
    //     successCallBack: (data) {
    //       var tmVerify = TMVerify.fromJson(data.data);
    //       print(tmVerify.verify);
    //     },
    ...
    DioManager().download(
        ...
        savePath: "$tempPath/20200424051744943.jpg",
